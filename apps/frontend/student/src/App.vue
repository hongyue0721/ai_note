...
let cardMotionCleanup: (() => void) | null = null
...
onMounted(() => {
  const cards = Array.from(document.querySelectorAll<HTMLElement>('.workspace-card, .note-node-card, .tag-review-card, .notes-search-panel, .topbar-metric'))
